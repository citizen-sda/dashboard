        ...
        <div class="card w-96 bg-base-100 shadow-xl">
          ...
          <div class="card-body">
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-2 mt-6">
              <button className="px-6 py-2 text-white bg-red-600 hover:bg-red-500 rounded-3xl">
                Tolak
              </button>
              <button className="px-3 py-2 text-white bg-green-500 hover:bg-green-400 rounded-3xl">
                Verifikasi
              </button>
            </div>
          </div>
